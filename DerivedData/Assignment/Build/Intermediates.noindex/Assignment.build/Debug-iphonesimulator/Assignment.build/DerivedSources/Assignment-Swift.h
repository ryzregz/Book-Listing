...
SWIFT_MODULE_NAMESPACE_PUSH("Assignment")
@class UIWindow;
@class UIApplication;
...
SWIFT_CLASS("_TtC10Assignment8BookCell")
...
- (void)dataUpdated:(NSNotification * _Nonnull)notification;
- (void)dataEnded:(NSNotification * _Nonnull)notification;
- (IBAction)refreshData:(id _Nonnull)sender;
